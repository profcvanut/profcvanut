...
(function () {
  ...
  "pt-BR": {
    ...
    "pub.localSourceHint": "Você pode atualizar manualmente ou usar o workflow automático do GitHub.",
    ...
    "home.project.name": "Potencializando a Aprendizagem: Uso de Modelos de Linguagem de Grande Escala para Apoiar Estudantes com TDAH",
    "home.project.p1": "Este projeto tem como objetivo desenvolver uma ferramenta de apoio a estudantes universitários com Transtorno de Déficit de Atenção e Hiperatividade (TDAH), utilizando Modelos de Linguagem de Grande Escala (LLMs) para fornecer recursos personalizados que melhorem a organização, o foco, a gestão do tempo e o desempenho acadêmico.",
    ...
    "projects.p1.name": "Potencializando a Aprendizagem: Uso de Modelos de Linguagem de Grande Escala para Apoiar Estudantes com TDAH",
    ...
    "projects.p1.desc2": "Espera-se que o projeto resulte no desenvolvimento de uma ferramenta inovadora, baseada em Modelos de Linguagem de Grande Escala (LLMs), capaz de oferecer suporte personalizado a estudantes universitários com TDAH, promovendo melhorias em organização, foco, gestão do tempo e engajamento acadêmico. Além de atender às necessidades individuais dos alunos, a solução deverá fornecer subsídios para docentes e equipes pedagógicas, permitindo um acompanhamento mais preciso e intervenções mais eficazes.",
  ...
  en: {
    ...
    "pub.localSourceHint": "You can update it manually or use the automatic GitHub workflow.",
    ...
    "home.project.name": "Enhancing Learning: Using Large-Scale Language Models to Support University Students with ADHD",
    "home.project.p1": "This project aims to develop a support tool for university students with Attention-Deficit/Hyperactivity Disorder (ADHD) using large language models (LLMs) to provide personalized resources that improve organization, focus, time management, and academic performance.",
    ...
    "projects.p1.name": "Enhancing Learning: Using Large-Scale Language Models to Support University Students with ADHD",
    "projects.p1.desc1": "This project aims to develop a support tool for university students with Attention-Deficit/Hyperactivity Disorder (ADHD) using large language models (LLMs) to provide personalized resources that improve organization, focus, time management, and academic performance.",
    "projects.p1.desc2": "The expected outcome is an LLM-based tool that provides personalized support to university students with ADHD, improving organization, focus, time management, and academic engagement. Beyond individual student needs, the solution should also support instructors and academic support teams by enabling closer follow-up and more effective interventions.",
    "projects.poweredBy": "Powered by Google"
  }
};
  ...
  function setLang(lang) {
    ...
    // Se a página de publicações existir, re-renderiza labels (ex: "Acessar"/"Open")
    if ($("#pubList")) {
  ...
  async function loadPublications() {
    ...
    function render(filtered) {
      ...
      statusEl.textContent = format(t("pub.status.loaded", currentLang), { count: filtered.length });

      if (filtered.length === 0) {
        statusEl.textContent = t("pub.status.none", currentLang);
        return;
      }
      ...
      for (const p of filtered) {
        ...
        if (url) {
          ...
          a.textContent = t("pub.link.open", currentLang);
          li.appendChild(a);
        }
    ...
    // Expondo para re-render quando trocar idioma
